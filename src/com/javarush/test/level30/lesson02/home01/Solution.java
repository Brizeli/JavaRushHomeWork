...
public class Solution {
    public static void main(String[] args) {
        Number number = new Number(NumerationSystemType._3, "21021020201000000102020102002010012010201021201200102001200210012");
        Number result = convertNumberToOtherNumerationSystem(number, NumerationSystemType._16);
        System.out.println(result);    //expected 110
    }

    public static Number convertNumberToOtherNumerationSystem(Number number, NumerationSystem expectedNumerationSystem) {
        int numeration = number.getNumerationSystem().getNumerationSystemIntValue();
        BigInteger bigInteger = new BigInteger(number.getDigit(), numeration);
