        ...
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (res==0) {
                    ...
                    res= df.format((Date)stock2.get("date")).compareTo(df.format((Date)stock1.get("date")));
                }
                if (res==0) {
                    double v1 = stock1.containsKey("last") ? (double) stock1.get("last") - (double) stock1.get("open") : (double) stock1.get("change");
                    double v2 = stock2.containsKey("last") ? (double) stock2.get("last") - (double) stock2.get("open") : (double) stock2.get("change");
                    res=Double.compare(v2,v1);
                }
                return res;
            }
        });
