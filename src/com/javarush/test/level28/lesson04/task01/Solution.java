...
public class Solution {
    ...
    public static class AmigoThreadFactory implements ThreadFactory {
        private static AtomicInteger nFactory=new AtomicInteger();
        private AtomicInteger nThread = new AtomicInteger(1);

        public AmigoThreadFactory() {
            nFactory.getAndIncrement();
        }
        ...
        public Thread newThread(Runnable r) {
            ...
            String name = String.format("%s-pool-%d-thread-%d", groupName, nFactory.get(), nThread.getAndIncrement());
            Thread result = new Thread(threadGroup, r, name);
